<div class="main-menu">
    <header class="header">
        <a href="<?=base_url('dashboard')?>" class="logo">Fiora Hotel</a>
    ...
    <div class="content">
        ...
        <div class="navigation">
            <ul class="menu js__accordion">
                <li class="current">
                    <a class="waves-effect" href="<?=base_url('dashboard')?>"><i class="menu-icon mdi mdi-view-dashboard"></i><span>Dashboard</span></a>
                </li>
                <!-- <li>
